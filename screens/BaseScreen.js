    ...
    render() {
        return (
            <View style={styles.container}>
                <TouchableOpacity onPress={this.moveToSlideFromRight}>
                    <Text style={styles.textButton}>
                        SLIDE FROM RIGHT SCREEN
                        </Text>
                    </TouchableOpacity>
                <TouchableOpacity onPress={this.moveToSlideFromBottom}>
                    <Text style={styles.textButton}>
                        SLIDE FROM BOTTOM SCREEN
                    </Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={this.moveToExpand}>
                    <Text style={styles.textButton}>
                        EXPAND SCREEN
                    </Text>
                </TouchableOpacity>
